...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_dir', type=str, default="/mmEMP/radar_pose/preprocess", help='Path for the origial dataset.')
    parser.add_argument('--save_dir', type=str, default='/mmEMP/radar_pose/preprocess', help='Path for saving preprocessing results.')
